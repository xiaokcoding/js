...
```powershell
pwsh -File "C:\Users\25286\.config\opencode\skills\apk-reverse\scripts\decode.ps1" -ApkPath "D:\DOWNLOAD\app.apk" -Clean
pwsh -File "C:\Users\25286\.config\opencode\skills\apk-reverse\scripts\decode.ps1" -ApkPath "D:\DOWNLOAD\app.apk" -Name demo -SkipJadx
```
...
```powershell
pwsh -File "C:\Users\25286\.config\opencode\skills\apk-reverse\scripts\frida-run.ps1" -ListDevices
pwsh -File "C:\Users\25286\.config\opencode\skills\apk-reverse\scripts\frida-run.ps1" -Usb -ListProcesses
pwsh -File "C:\Users\25286\.config\opencode\skills\apk-reverse\scripts\frida-run.ps1" -Usb -Spawn -Package com.example.app -ScriptPath "D:\hooks\test.js"
```
...
```powershell
pwsh -File "C:\Users\25286\.config\opencode\skills\apk-reverse\scripts\rebuild-sign-install.ps1" -ProjectDir "C:\work\apktool_out" -Clean
pwsh -File "C:\Users\25286\.config\opencode\skills\apk-reverse\scripts\rebuild-sign-install.ps1" -ProjectDir "C:\work\apktool_out" -Install -Reinstall -DeviceSerial "127.0.0.1:7555"
```
...
```powershell
pwsh -File "C:\Users\25286\.config\opencode\skills\apk-reverse\scripts\manifest-summary.ps1" -ManifestPath "C:\work\apktool_out\AndroidManifest.xml"
```
...
```powershell
pwsh -File "C:\Users\25286\.config\opencode\skills\apk-reverse\scripts\rebuild-sign-install.ps1" -ProjectDir "apktool_out" -Install -Reinstall -DeviceSerial "127.0.0.1:7555"
```
