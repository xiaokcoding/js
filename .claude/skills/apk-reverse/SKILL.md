...
```powershell
pwsh -File "scripts\decode.ps1" -ApkPath "app.apk" -Clean
pwsh -File "scripts\decode.ps1" -ApkPath "app.apk" -Name demo -SkipJadx
```
...
pwsh -File "scripts\frida-run.ps1" -Usb -Spawn -Package com.example.app -ScriptPath "hook.js"
```
...
```powershell
pwsh -File "scripts\rebuild-sign-install.ps1" -ProjectDir "apktool_out" -Clean
pwsh -File "scripts\rebuild-sign-install.ps1" -ProjectDir "apktool_out" -Install -Reinstall -DeviceSerial "127.0.0.1:7555"
```
